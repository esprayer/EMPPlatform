...
//        ClassLoader l = (ClassLoader)System.getProperties().get("BootClassLoader");
//        if ( l == null )
//          l = Thread.currentThread().getContextClassLoader();
     ...
     * @return Object
     */
    public abstract Object lookup (Class clazz,Object key,boolean sign);
    /**
     *
     * @param clazz Class
     * @param key Object
     * @return Object
     */
    public final Object lookup (Class clazz,Object key) {
      return lookup(clazz,key,true);
    }
    public final Object lookups(Class clazz,Object key) {
      return lookup(clazz,key,false);
    }
     ...
     */
    public final Result lookup (Template template) {
      return lookup(template,null);
    }
    public abstract Result lookup (Template template,Object key);
    ...
    public final Item lookupItem (Template template) {
      return lookupItem(template,null);
    }
    public Item lookupItem (Template template,Object key) {
 ...
 */
	...
	Empty() {}
         ...
         *   has been found
         */
        public Object lookup(Class clazz,Object key,boolean sign) {
            return null;
        }
         ...
         */
        public Result lookup(Template template,Object key) {
            return NO_RESULT;
        }
    }
}
