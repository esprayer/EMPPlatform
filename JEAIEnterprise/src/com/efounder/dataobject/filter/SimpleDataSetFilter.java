package com.efounder.dataobject.filter;
...
public class SimpleDataSetFilter implements RowFilterListener {
  /**
   *
   */
   ...
   */
  public SimpleDataSetFilter(DataSet dataSet,java.util.Map fValueList) {
    /**
     *
     */
...
//    valueFormatter = dataSet.getColumn(fieldName).getFormatter();
   ...
   * 构造函数
   */
  public SimpleDataSetFilter(DataSet dataSet,String fieldName,String fieldValue) {
    /**
     *
     */
    this.dataSet     = dataSet;
