 ...
 * @version 1.0
 */
public class FlowUnitTreeNode extends ModelTreeNode{
  //private StubObject  flowStub = null;
  //private List flowUnits = null;//存放该节点流程下的流程有部门，存放sys_flow_unit_date信息
  public FlowUnitTreeNode() {
  }

  /*public void setFlowUnits(List list){
    this.flowUnits = list;
  }
  public List getFlowUnits(){
     return flowUnits;
  }
  public void setFlowStub(StubObject flowStub){
    this.flowStub = flowStub;
  }
  public StubObject getFlowStub(){
    return this.flowStub;
  }*/
  //返回单位的上级单位编码
