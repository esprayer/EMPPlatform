 ...
 * @version 1.0
 */
public class JDALOracleDBObject extends EAIConnection {
  /**
   *
   */
  protected Object CustomDBManager = null;

  public JDALOracleDBObject() {
  }
  ...
  public Object InitConnection(Object ParamObject,Object DataObject,Object CustomObject,Object AdditiveObject) throws Exception {
    ...
    if ( Product != null )
      connection = (Connection)EAI.DAL.IOM(Product,"initConnection",PO,dataSourceStub,accountStub,dataStorageStub);
