...
public class CloseTabPaneEnhancedUI extends CloseTabPaneUI {
	...
	private static final Color lightBlue = SystemColor.textHighlight;//new Color(130, 200, 250, 50);

	private static final Color lightWhite = new Color(200, 200, 200, 50);

	private static final Color selectedColor = SystemColor.textHighlight;//RGB=10,36,106 new Color(15, 70, 180);
...
delta = delta2 = 0;
			if (tabPane.isEnabledAt(tabIndex)) {
				...
				rightGradient = new GradientPaint(x + w / 2, y, lightWhite, x
                        ...
                        g2.fillRect(x + 2, y + 2, w - 2 - delta2, h - 2);
//			Graphics2D g2 = (Graphics2D) g;
