...
public class JCOBJSubstringDialog
...
static ResourceBundle res = ResourceBundle.getBundle("jreport.swing.classes.wizard.imp.HelpCOBJDlg.ui.Language");
    ...
    public JCOBJSubstringDialog(Dialog parent, String title, boolean isModal) {
    ...
    private void jbInit() throws Exception {
        ...
        titledBorder1 = new TitledBorder(BorderFactory.createEtchedBorder(Color.white, new Color(169, 169, 164)), res.getString("String_2"));
        jPanel1.setLayout(borderLayout1);
        jPanel2.setBorder(border1);
        jPanel2.setLayout(borderLayout2);
        mCancelBtn.setPreferredSize(new Dimension(80, 25));
        mCancelBtn.setMnemonic('C');
        mCancelBtn.setText(res.getString("String_4"));
        ...
        jLabel1.setText(res.getString("String_5"));
        jLabel2.setText(res.getString("String_6"));
        ...
        mOkBtn.setText(res.getString("String_8"));
