package com.efounder.manager.meta.client.dctmodel;
 ...
 * @version 1.0
 */
public class DOFDCTMetaDataManager extends ClientMetaDataManager {
  public DOFDCTMetaDataManager() {
  }
  /**
   *
   * @param objid String
  ...
  protected MetaData getMetaDataModel(ESPContext ctx, String objid,MetaData metaData) throws Exception {
    ...
    paramObject.setValue("META_TYPE",MetaDataManager._DCTObject_);
...
//    MetaData metaData = null;
  ...
  public Object updateMetaData(ESPContext ctx, MetaData metaData) throws Exception {
    return updateMetaData(MetaDataManager._DCTObject_, ctx, metaData);
  }
}
