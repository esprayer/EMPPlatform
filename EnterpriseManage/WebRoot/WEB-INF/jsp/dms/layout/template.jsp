...
<link href="${ctx}/styles/theme/css/core.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${ctx}/styles/js/ixutils.js"></script>
<script type="text/javascript" src="${ctx}/styles/js/pdfhtm.js"></script>
