...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="${ctx}/queryAnalyse/help/helpMaterial?F_XMBH=${F_XMBH}F_CKBH=${F_CKBH}&beginDate=${beginDate}&endDate=${endDate}" onsubmit="return dwzSearch(this, 'dialog');">
	<div class="searchBar" >
