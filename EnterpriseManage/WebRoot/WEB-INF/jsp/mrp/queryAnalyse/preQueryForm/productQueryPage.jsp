...
<form method="post" action="${ctx}/queryAnalyse/productDetails" navTabId="productDetailsLiNav" title="项目产品查询" callbackType="closeCurrent" class="pageForm required-validate" onsubmit="return validateDialogCallback(this, dialogAjaxNavTab);">
