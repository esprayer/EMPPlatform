...
<form id="pagerForm" method="post" action="${ctx}/queryAnalyse/action/projectProductDetailsLCMaterial?beginDate=${beginDate}&endDate=${endDate}&F_XMBH=${F_XMBH}&F_CPBH=${F_CPBH}&F_CLBH=${F_CLBH}">
...
<form method="post" rel="pagerForm" action="${ctx}/queryAnalyse/action/projectProductDetailsLCMaterial"  class="pageForm" onsubmit="return navTabSearch(this,'projectProductDetailsLCMaterialLiNav')">
...
<form method="post" action="${ctx}/queryAnalyse/action/projectProductDetailsLCMaterial?beginDate=${beginDate}&endDate=${endDate}&F_XMBH=${F_XMBH}&F_CPBH=${F_CPBH}&F_CLBH=${F_CLBH}"  class="pageForm" onsubmit="return navTabSearch(this,'projectProductDetailsLCMaterialLiNav')">
	<div class="pageContent">
		<input type="hidden" name="pageNum" value="${page.pageNum}" />
		<div class="panelBar">
			<ul class="toolBar">			
				<li><a class="icon" target="navTab" rel="xmcpclDetailsLCDeployLiNav" href="${ctx}/queryAnalyse/action/xmcpclDetailsLCDeploy?beginDate=${beginDate}&endDate=${endDate}&F_XMBH=${F_XMBH}&F_CPBH=${F_CPBH}&{slt_objId}&CX=XMCPCL" title="材料联查用料调配"><span>材料联查用料调配</span></a></li>				
				<li class="line">line</li>
				<li><a class="icon" href="${ctx}/queryAnalyse/action/export/projectProductDetailsLCMaterial?beginDate=${beginDate}&endDate=${endDate}&F_XMBH=${F_XMBH}&F_CPBH=${F_CPBH}&F_CLBH=${F_CLBH}" target="dwzExport" targetType="navTab" title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
			</ul>
		</div>
