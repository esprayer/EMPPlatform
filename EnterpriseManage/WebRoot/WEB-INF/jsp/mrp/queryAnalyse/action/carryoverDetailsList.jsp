	...
	<div class="pageContent">
		...
		<div class="panelBar">
			<ul class="toolBar">
				...
				<li><a class="icon" href="${ctx}/queryAnalyse/action/export/carryoverDetails?F_CLBH=${F_CLBH}&F_DWBH=${F_DWBH}&F_CSBH=${F_CSBH}&F_CLDJ=${F_CLDJ}&F_CKBH=${F_CKBH}&F_CPBH=&F_XMZT=1&F_XMBH=${F_XMBH}" target="dwzExport" targetType="navTab" title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
			</ul>
		</div>
