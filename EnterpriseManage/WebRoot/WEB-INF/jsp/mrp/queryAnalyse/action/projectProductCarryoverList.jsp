...
<form id="pagerForm" method="post" action="${ctx}/queryAnalyse/action/projectProductCarryover?F_CLBH=${F_CLBH}&F_DWBH=${F_DWBH}&F_CSBH=${F_CSBH}&F_CLDJ=${F_CLDJ}&F_CKBH=${F_CKBH}&F_XMBH=${F_XMBH}&F_CPBH=${F_CPBH}&F_XMZT=1">
...
<form method="post" rel="pagerForm" action="${ctx}/queryAnalyse/action/projectProductCarryover?F_XMZT=1"  class="pageForm" onsubmit="return navTabSearch(this,'projectProductCarryoverNav')">
...
<form method="post" rel="pagerForm" action="${ctx}/queryAnalyse/action/projectProductCarryover?F_CLBH=${F_CLBH}&F_DWBH=${F_DWBH}&F_CSBH=${F_CSBH}&F_CLDJ=${F_CLDJ}&F_CKBH=${F_CKBH}&F_XMBH=${F_XMBH}&F_CPBH=${F_CPBH}&F_XMZT=1"  class="pageForm" onsubmit="return navTabSearch(this,'projectProductCarryoverNav')">
	<div class="pageContent">
		<input type="hidden" name="pageNum" value="${page.pageNum}" />
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="icon" target="navTab" rel="carryoverDetailsNav" href="${ctx}/queryAnalyse/action/carryoverDetails?F_CLBH=${F_CLBH}&F_DWBH=${F_DWBH}&F_CSBH=${F_CSBH}&F_CLDJ=${F_CLDJ}&F_CKBH=${F_CKBH}&F_XMBH=${F_XMBH}&F_XMZT=1{slt_objId}" title="结转明细"><span>结转明细</span></a></li>				
				<li class="line">line</li>
				<li><a class="icon" href="${ctx}/queryAnalyse/action/export/projectProductCarryover?F_CLBH=${F_CLBH}&F_DWBH=${F_DWBH}&F_CSBH=${F_CSBH}&F_CLDJ=${F_CLDJ}&F_CKBH=${F_CKBH}&F_XMBH=${F_XMBH}&F_CPBH=${F_CPBH}&F_XMZT=1" target="dwzExport" targetType="navTab" title="实要导出这些记录吗?"><span>导出EXCEL</span></a></li>
			</ul>
		</div>
