				...
				<li><a href="javascript">恒源部门名称</a>
					<ul>
						<c:forEach var="item" items="${hybmList}" varStatus="s">
							<li><a href="${ctx}/sysConfigure/deport/${item.f_BMBH}" target="ajax" rel="deportLiBox">${item.f_BMMC}</a></li>
						</c:forEach>
					</ul>
				</li>
			</ul>
		</div>
		<div  layoutH="0" id="deportLiBox" class="pageContent" style="margin-left:242px;">
