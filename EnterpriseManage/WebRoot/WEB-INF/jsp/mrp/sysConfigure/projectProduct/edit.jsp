...
<form method="post" action="${ctx}/sysConfigure/product/update/${hycpObject.f_CPBH}?F_XMBH=${hycpObject.f_XMBH}&rel=productLiBox&callbackType=closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
	<div class="pageFormContent" layoutH="56">
		...
		<p>
			<label>项目编号: </label>
			<input disabled="true" type="text" name="F_XMBH" value="${hycpObject.f_XMBH}" class="required"/>
		</p>
		<p>
			<label>项目名称: </label>
			<input disabled="true" type="text" name="F_XMMC" value="${hycpObject.f_XMMC}" class="required"/>
		</p>
		<p>
			<label>使用状态: </label>
