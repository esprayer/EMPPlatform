...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="${ctx}/storageDailyBusiness/projectHelp?F_CLBH=${F_CLBH}" onsubmit="return dwzSearch(this, 'dialog');">
		<input type="hidden" name="F_XMZT" value="0" />
