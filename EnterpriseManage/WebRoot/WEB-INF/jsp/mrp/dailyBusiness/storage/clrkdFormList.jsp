...
<form method="post" rel="pagerForm" action="${ctx}/dailyBusiness/storage/form/list"  class="pageForm" onsubmit="return navTabSearch(this,'storageLiNav')">
	<div class="pageFormContent">
		<div class="panel" defH="25">
			...
			<div>				
				...
				<input id="F_RKLX" name="F_RKLX" value="${F_RKLX}" type="hidden"/>
				...
				<p style="width:240px;padding: 0px;">
					...
					<c:if test="${F_RKLX=='0'}">
						<input readonly="readonly" name="F_RKLXMS" type="text" value="采购入库"/>
					</c:if>
					<c:if test="${F_RKLX=='1'}">
						<input readonly="readonly" name="F_RKLXMS" type="text" value="更换入库"/>
					</c:if>					
				</p>
				<ul class="rightTools">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" target="navTab" rel="storageNav" href="${ctx}/dailyBusiness/storage/form/addRkd?F_KJQJ=${F_KJQJ}&F_RKLX=${F_RKLX}" title="材料入库单据"><span>添加材料入库单据</span></a></li>
			<li><a class="edit" target="navTab" rel="storageNav" href="${ctx}/dailyBusiness/storage/form/edit/{slt_objId}?F_KJQJ=${F_KJQJ}&F_DJZT=${F_DJZT}&F_RKLX=${F_RKLX}" title="材料入库单据"><span>编辑材料入库单据</span></a></li>			
	...
	<table class="table" width="100%" layoutH="146">
		...
		<tbody>
		<c:forEach var="item" items="${hyrkdList}" varStatus="s">
