...
<style type="text/css">
	...
	#outBoundPreForm span.error{width:65px}
</style>

<form method="post" action="${ctx}/dailyBusiness/outBound" navTabId="outBoundLiNav" title="材料出库" callbackType="closeCurrent" class="pageForm required-validate" onsubmit="return validateDialogCallback(this, dialogAjaxNavTab);">
	<div id = "outBoundPreForm" class="pageFormContent" layoutH="56">
		...
		<p style="width:130px;padding: 0px;">
		...
		<p id="outBoundPreForm" style="width:240px;padding:15px 0px 0px 0px;">
		...
		<p style="width:240px;padding:15px 0px 0px 0px;">
			...
			<a class="btnLook" href="${ctx}/dictHelp/outBound/project/help/searchByKjqj/{F_CKBH}?F_XMZT=0&F_YEAR={F_YEAR}&F_MONTH={F_MONTH}&F_XMBH="  warn="请选择仓库信息" lookupGroup="">查找带回</a>	
			<span class="info"></span>
		</p>		
	</div>
	<div class="formBar">
