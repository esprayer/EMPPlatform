...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="${ctx}/dictHelp/outBound/project/help/search/${F_CKBH}?F_CRFX=R&F_XMZT=${F_XMZT}&tarRel=//help/dictHelp/ckxmHelp" onsubmit="return dwzSearch(this, 'dialog');">
