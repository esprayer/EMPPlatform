...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
		    ...
		    <li><a class="add" target="navTab" rel="roleUserNav" href="${ctx}/management/base/role/assignUser/{slt_objId}" title="角色用户"><span>角色用户</span></a></li>
		    <li><a class="edit" target="dialog"  mask="true" width="800" height="500" rel="rolegnDialog" href="${ctx}/management/qxgl/assignGnqx/{slt_objId}?Type=role&USER_ORGID=${USER_ORGID}" title="角色权限"><span>角色权限</span></a></li>
