...
@Repository
public class EMPMaterialDetailsLCDetails {
	...
	public void getOriginData(Statement stmt, JParamObject po) throws Exception {
		...
		try {
			...
			//插入入库数量
			strSql = " insert into " + msTableName + " (F_KJQJ, F_DJBH, F_CRFX, F_CKBH, F_XMBH, F_CPBH, F_CLBH, F_DWBH, F_CSBH, F_CLDJ, F_CLSL)"
			       + " select F_KJQJ, F_DJBH, F_CRFX, F_CKBH, F_XMBH, F_CPBH, F_CLBH, F_DWBH, F_CSBH, F_CLDJ,"
			       + " round(sum(F_CLSL), 2)"
			       + " from HYXMCK"
			       + " where HYXMCK.F_CLBH = '" + F_CLBH + "'"
			       + " and HYXMCK.F_DWBH = '" + F_DWBH + "'"
			       + " and HYXMCK.F_CSBH = '" + F_CSBH + "'"			       
			       + " and HYXMCK.F_CLDJ = " + F_CLDJ + " and HYXMCK.F_CRFX = 'R'"
			       + " and HYXMCK.F_XMBH = '" + F_XMBH + "' and HYXMCK.F_CKBH = '" + F_CKBH + "' and HYXMCK.F_CPBH like '%" + F_CPBH + "%'"
			       + " and HYXMCK.F_CHDATE < " + endDate.getTime() + " and HYXMCK.F_CHDATE >= " + beginDate.getTime()
			       + " group by F_KJQJ, F_DJBH, F_CKBH, F_XMBH, F_CPBH, F_CLBH, F_DWBH, F_CSBH, F_CLDJ";
			stmt.execute(strSql);
			
			//插入正常出库数量
			strSql = " insert into " + msTableName + " (F_KJQJ, F_DJBH, F_CRFX, F_CKBH, F_XMBH, F_CPBH, F_YYCKBH, F_YYXMBH, F_YYCPBH, F_CLBH, F_DWBH, F_CSBH, F_CLDJ, F_CLSL)"
		           + " select F_KJQJ, F_DJBH, F_CRFX, F_CKBH, F_XMBH, F_CPBH, F_YYCKBH, F_YYXMBH, F_YYCPBH, F_CLBH, F_DWBH, F_CSBH, F_CLDJ,"
		           + " round(sum(F_CLSL), 2)"
		           + " from HYXMCK"
		           + " where HYXMCK.F_CLBH = '" + F_CLBH + "'"
		           + " and HYXMCK.F_DWBH = '" + F_DWBH + "'"
		           + " and HYXMCK.F_CSBH = '" + F_CSBH + "'"			       
		           + " and HYXMCK.F_CLDJ = " + F_CLDJ + " and HYXMCK.F_CRFX = 'C'"
		           + " and (HYXMCK.F_XMBH = '" + F_XMBH + "' or HYXMCK.F_YYXMBH = '" + F_XMBH + "') and HYXMCK.F_YYCKBH = '" + F_CKBH + "'"
		           + " and HYXMCK.F_CHDATE < " + endDate.getTime() + " and HYXMCK.F_CHDATE >= " + beginDate.getTime()
		           + " group by F_KJQJ, F_DJBH, F_CRFX, F_CKBH, F_XMBH, F_CPBH, F_YYCKBH, F_YYXMBH, F_YYCPBH, F_CLBH, F_DWBH, F_CSBH, F_CLDJ";
			stmt.execute(strSql);
			...
			strSql = " insert into " + msTableName + " (F_KJQJ, F_DJBH, F_CRFX, F_CKBH, F_XMBH, F_CPBH, F_YYCKBH, F_YYXMBH, F_YYCPBH, F_CLBH, F_DWBH, F_CSBH, F_CLDJ, F_CLSL)"
			       ...
			       + " and HYXMCK.F_DWBH = '" + F_DWBH + "'"
			       + " and HYXMCK.F_CSBH = '" + F_CSBH + "'"			       
			       + " and HYXMCK.F_CLDJ = " + F_CLDJ + " and (HYXMCK.F_CRFX = 'D' or HYXMCK.F_CRFX = 'T')"
			       + " and HYXMCK.F_YYXMBH = '" + F_XMBH + "' and HYXMCK.F_YYCKBH = '" + F_CKBH + "' and HYXMCK.F_YYCPBH like '%" + F_CPBH + "%'"
			       + " and HYXMCK.F_CHDATE < " + endDate.getTime() + " and HYXMCK.F_CHDATE >= " + beginDate.getTime()
			       + " group by F_KJQJ, F_DJBH, F_CRFX, F_CKBH, F_XMBH, F_CPBH, F_YYCKBH, F_YYXMBH, F_YYCPBH, F_CLBH, F_DWBH, F_CSBH, F_CLDJ";
			stmt.execute(strSql);
		} catch(Exception ce) {
	...
	protected void createTempTable(Statement stmt) throws Exception{
	    msTableName = "CLMXLCMX"+StringFunction.getTempStr(6);
	    String        strSql = "";
	...
	public EFDataSet convertDataSet(Statement stmt, JParamObject po) throws Exception {
		...
		strSql = " select F_KJQJ, F_DJBH, F_CKBH, F_CKMC, F_XMBH, F_XMMC, F_CPBH, F_CPMC, "
			   + " F_YYCKBH, F_YYCKMC, F_YYXMBH, F_YYXMMC, F_YYCPBH, F_YYCPMC, "
			   + " F_CLBH, F_CLMC, F_GGXH, F_JLDW, F_DWBH, F_DWMC, F_CSBH, F_CSMC, "
			   + " F_CRFX, concat(F_CRFX,F_DJLX) as F_DJLX, F_CLDJ, F_CLSL from " + msTableName + " order by F_SBDATE";
		...
		if(pageQuery == null) {
			if(queryDataset.getRowCount() > 0) queryDataset.insertRowSet(hjRrowset);
