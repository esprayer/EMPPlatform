...
public class HYRKDMX extends AbstractDO{
	...
	public double getF_RKSL() {
		return F_RKSL;
	}

	public void setF_RKSL(double f_RKSL) {
		F_RKSL = f_RKSL;
	}
	...
	public void setF_ROW(int f_ROW) {
		F_ROW = f_ROW;
	}
	...
	public void setF_COL(int f_COL) {
		F_COL = f_COL;
	}
