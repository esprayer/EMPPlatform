package dwz.business.standard.metadata.impl;
...
import dwz.business.standard.MetadataColumnObject;
...
public class MetadataServiceMgrImpl extends AbstractBusinessObjectServiceMgr
		implements MetadataServiceMgr {
	@Autowired
