...
public class MemoryShowPanel
    extends JPanel {

    public MemoryShowPanel() {
        try {
            jbInit();
        }
        catch (Exception ex) {
    ...
    private void jbInit() throws Exception {
        ...
        setPanel.setLayout(flowLayout1);
        flowLayout1.setAlignment(FlowLayout.LEFT);
        jLabel1.setText("ms");
        jLabel2.setText("采样时间间隔：");
        gcButton.setPreferredSize(new Dimension(60, 22));
        gcButton.setMnemonic('G');
        gcButton.setText("GC");
        ...
        timeInterval.getModel().setValue(new Integer(1000));
        switchButton.setPreferredSize(new Dimension(80, 22));
        ...
        setPanel.add(timeInterval);
        setPanel.add(jLabel1);
        cmdPanel.add(switchButton);
        cmdPanel.add(gcButton);
        this.add(setPanel, java.awt.BorderLayout.NORTH);
        this.add(surface, java.awt.BorderLayout.CENTER);
    ...
    private void onStartStop() {
        if (switchButton.getText().indexOf("Start") >= 0) {
            switchButton.setText("Stop");
            try {
                String interval = timeInterval.getValue().toString();
                surface.sleepAmount = Long.parseLong(interval);
            } catch (Exception ex) {}
            surface.start();
        } else {
            surface.stop();
    ...
    public class Surface
        ...
        public void paint(Graphics g) {
            ...
            big.drawString("Total:" + String.valueOf( (int) totalMemory / 1024) +
                           "K", 4.0f, (float) ascent + 0.5f);
            usedStr = String.valueOf("Used:" +  ( (int) (totalMemory - freeMemory)) /
                                     1024) + "K";
        ...
        public void start() {
            ...
            thread.setName("JavaApplicationMemoryMonitor");
            thread.start();
        }
