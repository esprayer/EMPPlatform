...
//修改:
//--------------------------------------------------------------------------------------------------
public class JDocumentListPanel extends JBOFMDIChildWindow {
  ...
  //修改:
  //------------------------------------------------------------------------------------------------
  public JDocumentListPanel(JBOFApplication App,JActiveObject AO) {
    super(App,AO);
    try {
      jbInit();
    }
  ...
  void jbInit() throws Exception {
    jLabel1.setText(res.getString("String_1"));
