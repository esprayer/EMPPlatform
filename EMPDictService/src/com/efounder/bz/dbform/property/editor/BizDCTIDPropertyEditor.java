 ...
 * @version 1.0
 */
public class BizDCTIDPropertyEditor extends AbstractPropertyEditor implements ActionListener{
...
//    if ( DCT_ID == null || DCT_ID.trim().length() == 0 ) return;
    ...
    String[] dataSetKeys = bizMetaData.getRefDCTIDs();
    ...
    for(int i=0;i<dataSetKeys.length;i++) {
      ...
      DCTMetaData mdm=bizMetaData.getRefDCTMetaData(dataSetKey);
