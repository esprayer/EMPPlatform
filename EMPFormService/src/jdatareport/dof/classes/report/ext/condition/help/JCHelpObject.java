package jdatareport.dof.classes.report.ext.condition.help;
...
public class JCHelpObject {
    ...
    static {
        mResourceBundle = ResourceBundle.getBundle("jdatareport.dof.classes.report.ext.condition.help.HelpMap");
    }
    ...
    private Object invokeDofHelpObject(String methodName, JParamObject PO) {
        String[] helpData = (String[]) JActiveDComDM.DataActiveFramework.InvokeObjectMethod("HelpObject", methodName, PO);
        String obj = null;
        if (helpData != null) {
            obj = helpData[0];
        }
