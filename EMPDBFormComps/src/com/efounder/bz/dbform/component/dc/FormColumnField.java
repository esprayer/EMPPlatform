 ...
 * @version 1.0
 */
public class FormColumnField extends JTextField implements DataSetListener,FormComponent,DMComponent,DMColComponent,CellEditor {
  /**
   *
   */
   ...
   * @param        mask String
   */
  public FormColumnField(String mask) throws ParseException {
   ...
   */
  public FormColumnField(String mask, String regexPattern) throws
      ParseException {
   ...
   * @param regexPattern String
   */
  public FormColumnField(String mask, boolean useRegex, String regexPattern) throws
      ParseException {
      try {
          this.editMask = mask;
