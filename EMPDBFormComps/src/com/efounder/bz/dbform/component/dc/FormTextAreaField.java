 ...
 * @version 1.0
 */
public class FormTextAreaField extends JTextArea implements DataSetListener,FormComponent,DMComponent,DMColComponent,CellEditor {
  /**
   *
   */
   ...
   * @param        mask String
   */
  public FormTextAreaField(String mask) throws ParseException {
   ...
   */
  public FormTextAreaField(String mask, String regexPattern) throws
      ParseException {
   ...
   * @param regexPattern String
   */
  public FormTextAreaField(String mask, boolean useRegex, String regexPattern) throws
      ParseException {
      try {
          this.editMask = mask;
