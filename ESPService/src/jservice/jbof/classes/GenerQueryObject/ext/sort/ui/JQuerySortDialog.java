...
//        });
        ...
        this.addActionListener(this.mSelBtn, "onSelect");
        this.addActionListener(this.mUnselBtn, "onUnselect");
        this.addActionListener(this.mSelAllBtn, "onSelectAll");
        this.addActionListener(this.mUnselAllBtn, "onUnselectAll");

        this.addActionListener(this.mUpBtn, "onUp");
        this.addActionListener(this.mDownBtn, "onDown");

        this.addActionListener(this.mOkBtn, "onOk");
        this.addActionListener(this.mCancelBtn, "onCancel");
