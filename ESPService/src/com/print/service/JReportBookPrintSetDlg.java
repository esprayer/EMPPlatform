...
//    PrinterJob CurrentPrinterJob = null;
    ...
    public JReportBookPrintSetDlg(JBook book) {
        this(JActiveDComDM.MainApplication.MainWindow, res.getString("String_264"), true,book);
    }
    ...
    private void jbInit() throws Exception {
        ...
        titledBorder2 = new TitledBorder(BorderFactory.createEtchedBorder(Color.white, new Color(148, 145, 140)), res.getString("String_266"));
        border2 = BorderFactory.createEtchedBorder(Color.white, new Color(148, 145, 140));
        titledBorder3 = new TitledBorder(border2, res.getString("String_267"));
        border3 = BorderFactory.createEtchedBorder(Color.white, new Color(148, 145, 140));
        titledBorder4 = new TitledBorder(border3, res.getString("String_268"));
        border4 = BorderFactory.createEtchedBorder(Color.white, new Color(148, 145, 140));
        titledBorder5 = new TitledBorder(BorderFactory.createEtchedBorder(Color.white, new Color(148, 145, 140)), res.getString("String_269"));
        border5 = BorderFactory.createEtchedBorder(Color.white, new Color(148, 145, 140));
        titledBorder6 = new TitledBorder(border5, res.getString("String_270"));
        border6 = BorderFactory.createEmptyBorder(5, 5, 5, 5);
        border7 = BorderFactory.createEmptyBorder(5, 5, 5, 5);
        border8 = BorderFactory.createCompoundBorder(new TitledBorder(BorderFactory.createEtchedBorder(Color.white, new Color(148, 145, 140)), res.getString("String_271")), BorderFactory.createEmptyBorder(5, 5, 5, 5));
        ...
        jLabel1.setText(res.getString("String_272"));
        ...
        bnPrintAttrib.setText(res.getString("String_273"));
...
//        cbPrintList.setMinimumSize(new Dimension(31, 25));
        ...
        jLabel2.setText(res.getString("String_274"));
        jPanel5.setLayout(flowLayout2);
        flowLayout2.setAlignment(FlowLayout.LEFT);
        flowLayout2.setHgap(0);
        flowLayout2.setVgap(0);
        jLabel3.setBorder(border7);
        jLabel3.setText(res.getString("String_275"));
        jLabel4.setBorder(border7);
        jLabel4.setText(res.getString("String_276"));
        ...
        jLabel7.setText(res.getString("String_281"));
        ...
        rbPrintF1Book.setText(res.getString("String_282"));
        rbPrintSelectArea.setText(res.getString("String_283"));
        ...
        jLabel15.setText(res.getString("String_284"));
        rbPrintScale1.setText(res.getString("String_285"));
        spnPrintScale1.setMinimumSize(new Dimension(31, 26));
        spnPrintScale1.setPreferredSize(new Dimension(55, 26));
        rbPrintScale2.setText(res.getString("String_286"));
        ...
        jLabel14.setText(res.getString("String_287"));
        jLabel16.setText(res.getString("String_288"));
        ...
        cbReportDefaultPage.setText(res.getString("String_291"));
        jRadioButton8.setEnabled(false);
        jRadioButton8.setToolTipText("");
        jRadioButton8.setText(res.getString("String_293"));
        jRadioButton9.setEnabled(false);
        jRadioButton9.setText(res.getString("String_294"));
        ...
        bnOK.setText(res.getString("String_299"));
        bnCancel.setText(res.getString("String_300"));
        ...
        cbPrintDefaultSize.setText(res.getString("String_301"));
        ...
        rbVPrint.setText(res.getString("String_302"));
        rbHPrint.setText(res.getString("String_303"));
        ...
        rbNoColor.setText(res.getString("String_304"));
        ...
        setTitle(res.getString("String_305"));
