/**
 * Copyright (c) 1996-2003 Borland Software Corp. All Rights Reserved.
 *
...
// JDK 1.2.2
  ...
  public Dimension getPreferredSize(JComponent c) {
    ...
    //  width = header.getCellRenderer().getTableCellRendererComponent(table, header, false, false, model.getRowCount(), header.PREF_SIZE).getPreferredSize().width;
      ...
      width = header.getCellRenderer().getTableCellRendererComponent(table, header, false, false,count , header.MAX_SIZE).getPreferredSize().width;
    }
