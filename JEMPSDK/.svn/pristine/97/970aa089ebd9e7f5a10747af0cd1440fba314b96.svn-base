...
final class MetaInfServicesLookup extends AbstractLookup {
     ...
     */
    protected final void beforeLookup(Lookup.Template t,Object key) {
        Class c = t.getType();
     ...
     */
    private void search(Class clazz, Collection result,Object key) {
        ...
        Enumeration en;
        try {
          Vector clazzList = PackageStub.getContentVector(clazz.getName());
          if ( clazzList == null ) return;
          en = clazzList.elements();
