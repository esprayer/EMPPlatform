...
//            Object transaction = t.beginTransaction ();
    ...
    public final Object lookup (Class clazz,Object key,boolean sign) {
        Lookup.Item item = lookupItem (new Lookup.Template (clazz),key);
     ...
     * @return item or null
     */
    public final Lookup.Item lookupItem (Lookup.Template template,Object key) {
        AbstractLookup.this.beforeLookup (template,key);
     ...
     */
    public final Lookup.Result lookup (Lookup.Template template,Object key) {
        for (;;) {
    ...
    static final class R extends WaitableResult {
        ...
        private void setClassesCache (Set s) {
            ...
            if (!(reference.caches instanceof Object[])) reference.caches = new Object[3];
        ...
        public Collection allInstances () {
            reference.lookup.beforeLookup (reference.template,null);
        ...
        protected void beforeLookup(Lookup.Template t) {
            if (t.getType () == reference.template.getType ()) {
                reference.lookup.beforeLookup (t,null);
            }
        }
     ...
     */
    static final class ReferenceToResult extends WeakReference
    implements Runnable {
        ...
        public void cloneList (AbstractLookup.Storage storage) {
            ...
            while (it.next ()) {
                ...
                ReferenceToResult newRef = new ReferenceToResult (
