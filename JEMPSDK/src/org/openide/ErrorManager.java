...
public abstract class ErrorManager extends Object {
    ...
    */
   public abstract void notify (int severity, Throwable t,Object fireObject,String message);
   public void notify (int severity, Throwable t,Object fireObject) {
     notify(severity,t,fireObject,null);
   }

    public void notify (int severity, Throwable t) {
      notify(severity,t,null);
    }
    ...
    */
    public final void notify (Throwable t,Object fireObject) {
        notify(UNKNOWN, t,fireObject);
    }
    public final void notify (Throwable t) {
        notify(UNKNOWN, t,null);
    }
    ...
    private static class DelegatingErrorManager extends ErrorManager
        ...
        public void notify (int severity, Throwable t,Object fireObject,String message) {
            ...
            try {
                ...
                for (Iterator i = delegates.iterator(); i.hasNext(); ) {
                    ErrorManager em = (ErrorManager)i.next();
                    em.notify(severity, t,fireObject,message);
                }
            } catch (RuntimeException e) {
                // #20467
                e.printStackTrace();
