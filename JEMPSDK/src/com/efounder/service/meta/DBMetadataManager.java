...
public abstract class DBMetadataManager {
  ...
  protected final void getColRefDictMetadata(MetaContextObject mco,TableMetadata tableMetadata) throws Exception {
    java.util.List colList = tableMetadata.getColList();ColumnMetaData colMetadata = null;
   ...
   * @throws Exception
   */
  protected abstract void getColRefDictMetadata(MetaContextObject mco,TableMetadata tableMetadata,ColumnMetaData colMetadata) throws Exception;
  /**
   *
   * @param mco MetaContextObject
   * @param tableMetadata TableMetadata
