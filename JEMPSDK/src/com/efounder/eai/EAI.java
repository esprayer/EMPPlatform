...
//  public static IManagerScript   MSP     = null;// �ű�����
  public static IManagerApplication  MA  = null;// ��Ʒ����
  public static IRegistry        Registry                    = null;// ���ע����Ϣ
  public static JLocalRegistry   LocalRegistry               = null;// ����ע����Ϣ
  ...
  public static JApplication  EA         = null;//
