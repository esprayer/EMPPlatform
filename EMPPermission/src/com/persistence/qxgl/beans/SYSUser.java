...
public class SYSUser extends AbstractDO{
	...
	private String USER_ORGID_NAME  = "";
	...
	public String getUSER_ORGID_NAME() {
		return USER_ORGID_NAME;
	}
	public void setUSER_ORGID_NAME(String uSER_ORGID_NAME) {
		USER_ORGID_NAME = uSER_ORGID_NAME;
	}
